...
import FeatureExtraction_BagOfWords as extractor
...
if __name__ == '__main__':
	...
	for (c1,c2) in [("control", "depression"), ("ptsd", "depression"), ("control", "ptsd")]:
		...
		max_features = 5000
		data = extractor.BagOfWords(c1, c2, max_features)

		for name, model in zip(names, classifiers):

			runClassification(name, model, data, c1, c2,"../results_prod/BagOfWords/")